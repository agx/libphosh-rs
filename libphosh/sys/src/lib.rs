...
extern "C" {
    ...
    //pub fn phosh_lockscreen_manager_get_lockscreen(self_: /*Ignored*/*mut PhoshLockscreenManager) -> *mut PhoshLockscreen;
    ...
    pub fn phosh_quick_setting_get_has_status(self_: *mut PhoshQuickSetting) -> gboolean;
    pub fn phosh_quick_setting_get_present(self_: *mut PhoshQuickSetting) -> gboolean;
    ...
    pub fn phosh_quick_setting_set_has_status(self_: *mut PhoshQuickSetting, has_status: gboolean);
    pub fn phosh_quick_setting_set_present(self_: *mut PhoshQuickSetting, present: gboolean);
    pub fn phosh_quick_setting_set_status_icon(self_: *mut PhoshQuickSetting, widget: *mut PhoshStatusIcon);
    ...
    //pub fn phosh_status_page_get_footer(self_: /*Ignored*/*mut PhoshStatusPage) -> *mut gtk::GtkWidget;
    //pub fn phosh_status_page_get_header(self_: /*Ignored*/*mut PhoshStatusPage) -> *mut gtk::GtkWidget;
    //pub fn phosh_status_page_get_title(self_: /*Ignored*/*mut PhoshStatusPage) -> *const c_char;
    //pub fn phosh_status_page_set_footer(self_: /*Ignored*/*mut PhoshStatusPage, footer: *mut gtk::GtkWidget);
    //pub fn phosh_status_page_set_header(self_: /*Ignored*/*mut PhoshStatusPage, header: *mut gtk::GtkWidget);
    //pub fn phosh_status_page_set_title(self_: /*Ignored*/*mut PhoshStatusPage, title: *const c_char);
